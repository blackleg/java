...
public class DniIncorrectException extends Exception {
    ...
    /**
     * Creates a new instance of <code>DniIncorrectException</code> without
     * detail message.
     */
    ...
    /**
     * Constructs an instance of <code>DniIncorrectException</code> with the
     * specified detail message.
     *
     * @param msg the detail message.
     */
    public DniIncorrectException(String msg) {
        super(msg);
    }
}
